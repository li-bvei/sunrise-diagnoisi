...
面向 SUNRISE 客户公开使用的独立专业诊断前台。项目不接入原行政书士 ERP；目前已上线“高度人才积分计算”（结果页内含独立的“特别高度人才J-Skip”基础判断）、“永住申请条件诊断”与“租房初期费用诊断”，其余工具陆续开放。
...
- 其余 5 项工具（不动产买房/卖房、公司经营、工资年金相关）的真实诊断表单与计算逻辑
