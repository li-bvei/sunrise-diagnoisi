  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'tools/payroll', name: 'payroll', component: () => import('@/views/PayrollCalculatorView.vue'), meta: { title: { zh: '工资手取与公司实际成本', ja: '給与手取り・会社実質負担' } } },
        { path: 'tools/standard-remuneration', name: 'standard-remuneration', component: () => import('@/views/StandardRemunerationView.vue'), meta: { title: { zh: '标准报酬月额反查', ja: '標準報酬月額逆引き' } } },
        { path: 'tools/pension', name: 'pension', component: () => import('@/views/PensionCalculatorView.vue'), meta: { title: { zh: '日本年金估算与目标反推', ja: '年金見込額・目標逆算' } } },
        { path: 'tools/executive-compensation', name: 'executive-compensation', component: () => import('@/views/ExecutiveCompensationView.vue'), meta: { title: { zh: '役员报酬模拟器', ja: '役員報酬シミュレーター' } } },
