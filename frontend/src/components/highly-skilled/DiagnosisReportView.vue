...
const suggestionLabels: Record<string, [string, string]> = {
  ...
  verifyUniversity: ['请使用毕业证明上的正式英文校名重新搜索；未匹配的学校本次不计入院校加分。', '卒業証明書の正式英語名で再検索してください。一致しない大学は今回の大学加点に算入しません。'],
  ...
  activityReview: ['请确认预定活动是否属于所选活动类型。', '予定活動が選択した活動類型に該当するか確認してください。'],
